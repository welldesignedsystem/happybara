  ...
  return (
    <section className="hours-section" id="hours">
      ...
      <div className="hours-grid">
        <div className="hours-card"><div className="hours-day">Every Day</div><div className="hours-time">7:00 AM – 10:00 PM</div><div className="hours-meal">Breakfast · Lunch · Dinner</div></div>
      </div>
